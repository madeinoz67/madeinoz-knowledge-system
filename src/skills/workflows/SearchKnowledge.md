...
```bash
# Search from today
bun run src/skills/tools/knowledge-cli.ts search_nodes "PAI skills" --since today

# Search from last 7 days
bun run src/skills/tools/knowledge-cli.ts search_nodes "PAI skills" --since 7d

# Search within date range
bun run src/skills/tools/knowledge-cli.ts search_nodes "PAI skills" --since 2026-01-01 --until 2026-01-15

# Yesterday only
bun run src/skills/tools/knowledge-cli.ts search_nodes "PAI skills" --since yesterday --until today
```

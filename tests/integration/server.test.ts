...
describe('Server Scripts Integration', () => {
  ...
  describe('Start Script Workflow', () => {
    it('should start FalkorDB container when not running', async () => {
      ...
      ctx.mockExec(
        ['ps', '--filter', 'name=madeinoz-knowledge-falkordb', '--format', '{{.Status}}'],
        {
          success: true,
      ...
      ctx.mockExec(
        ['ps', '-a', '--filter', 'name=madeinoz-knowledge-falkordb', '--format', '{{.Names}}'],
        {
          success: true,
    ...
    it('should start MCP server container after FalkorDB', async () => {
      ...
      ctx.mockExec(
        ['ps', '-a', '--filter', 'name=madeinoz-knowledge-graph-mcp', '--format', '{{.Names}}'],
        {
          success: true,
  ...
  describe('Stop Script Workflow', () => {
    it('should stop MCP server container', async () => {
      ...
      ctx.mockExec(
        ['ps', '--filter', 'name=madeinoz-knowledge-graph-mcp', '--format', '{{.Status}}'],
        {
          success: true,
